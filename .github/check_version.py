...
Check version number in setup.json and aiida_ddec/__init__.py and make sure
they match.
"""
import os
import json
...
import aiida_ddec  # pylint: disable=wrong-import-position
VERSION = aiida_ddec.__version__

if VERSION != SETUP_CONTENT['version']:
    print('version number mismatch detected:')
    print("version number in '{}': {}".format(SETUP_FNAME, SETUP_CONTENT['version']))
    print("version number in '{}/__init__.py': {}".format('aiida_ddec', VERSION))
    sys.exit(1)
