...
class DdecCp2kRelaxChargesWorkChain(WorkChain):
    """A workchain that computes DDEC charges using D. Ongari's multistage CP2K workchain"""

    @classmethod
    def define(cls, spec):
        """Define workflow specification."""
        super(DdecCp2kRelaxChargesWorkChain, cls).define(spec)
